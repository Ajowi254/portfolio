...
<p align="center">
  ...
  <br/>
src="https://api.netlify.com/api/v1/badges/abf59f82-3251-4040-b24c-949b86691642/deploy-status?style=flat-square" /></a>
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://git@github.com:Ajowi254/portfolio.git
  ```
...
er/prettier-logo) for [prettier](https://github.com/prettier/prettier) 
